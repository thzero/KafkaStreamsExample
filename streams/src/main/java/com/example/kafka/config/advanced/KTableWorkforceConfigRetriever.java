...
@Component("advancedKTableWorkforceConfig")
public class KTableWorkforceConfigRetriever extends BaseConfigRetriever {
...
//        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, JsonNode.class);
    ...
    @Value("${applications.advanced.workforce-ktable.id}")
