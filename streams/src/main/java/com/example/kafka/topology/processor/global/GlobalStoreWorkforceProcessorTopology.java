...
public class GlobalStoreWorkforceProcessorTopology extends WorkforceProcessorTopology {
    ...
    protected void defineTopology(@NonNull Topology builder) {
        ...
        builder
                ...
                .addSink(GlobalStoreMergeProcessor.KeySinkWorkforceTransactionRedacted, appConfig.changeRequestTransactionRedactedTopic, stringSerde.serializer(), workforceChangeRequestSerde.serializer(), GlobalStoreMergeProcessor.TAG)
